...
fetch("https://restcountries.com/v2/all?fields=name&fields=flags&fields=borders&fields=population&fields=region&fields=capital&fields=alpha3Code&fields=languages&fields=currencies")
  .then((res) => res.json())
  .then((data) => {
    countries = data;
    loading.innerHTML = "";
